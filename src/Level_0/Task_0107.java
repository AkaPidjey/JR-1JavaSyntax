...
/**
 * Title - Комментарии излишни # 0107
 * @task Раскомментируй одну строчку, чтобы программа вывела на экран числа 12 и 2 (сначала 12, а затем 2).
 *
 * Требования:
