package Level_4.Task_0410;

/**
 * Title - Попадём-не-попадём # 0410.
 * @task Напишите метод checkInterval. Метод должен проверять попало ли целое число в интервал от 50 до 100
