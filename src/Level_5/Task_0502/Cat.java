package Level_5.Task_0502;

/**
 * Title - Реализовать метод fight # 0502.
 * @task Реализовать метод boolean fight(Cat anotherCat):
...
public class Cat {
    ...
    public boolean fight(Cat anotherCat) {
        int it1 = Integer.compare(this.age, anotherCat.age);
        int it2 = Integer.compare(this.weight, anotherCat.weight);
        int it3 = Integer.compare(this.strength, anotherCat.strength);
        int itog = it1 + it2 + it3;
        return itog > 0;
    }
