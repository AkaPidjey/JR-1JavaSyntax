...
/**
 * Title - Перехват unchecked-исключений# 0917.
 * @task В методе handleExceptions обработайте все unchecked исключения.
 ...
 * •	Метод handleExceptions должен отлавливать все unchecked исключения и
...
public class Task_0917 {
    public static void main(String[] args) {
        handleExceptions(new Task_0917());
    }

    public static void handleExceptions(Task_0917 obj) {
        try {
            obj.method1();
            obj.method2();
            obj.method3();
