...
/**
 * Title - Множество всех животных # 0820.
 * @task 1. Внутри класса Solution создать public static классы Cat, Dog без конструктора или с конструктором без параметров.
...
public class Task_0820 {
    ...
    public static Set<Cat> createCats() {
        Set<Cat> koshaki = new HashSet<Cat>();
        koshaki.add(new Cat());
        koshaki.add(new Cat());
        koshaki.add(new Cat());
        koshaki.add(new Cat());
    ...
    public static Set<Dog> createDogs() {
        Set<Dog> sobaki = new HashSet<Dog>();
        sobaki.add(new Dog());
        sobaki.add(new Dog());
        sobaki.add(new Dog());
        return sobaki;
