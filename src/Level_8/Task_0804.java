...
/**
 * Title - Вывести на экран список ключей # 0804.
 * @task Есть коллекция Map<String, String> (реализация HashMap), туда занесли 10 различных строк.
