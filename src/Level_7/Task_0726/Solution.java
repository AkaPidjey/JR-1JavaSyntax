...
/**
 * Title - Не компилируется задача про котиков # 0726.
 * @task Задача: Программа вводит с клавиатуры данные про котов и выводит их на экран.
 *
 * Пример:
